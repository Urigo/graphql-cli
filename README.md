...
Currently we have `4.0.0-alpha.10` version. Help us to improve new GraphQL CLI. Checkout new structure and commands below!
...
Each command in GraphQL CLI is a seperate package, so you can have your own plugins or use the ones we maintain. You can have those commands by installing them like `@test-graphql-cli/[COMMAND-NAME]@4.0.0-alpha.10`.
